...
var i18n = new Jed({
  ...
  locale_data : {
    "messages" : {
      ...
      "fears" : ['מהם חששותיך מהשירות הצבאי כמש"ק דוברות?'],
      ...
      "tzipiot" : ['מהן ציפיותך מהשירות הצבאי כמש"ק דוברות?'],
      "videoEditing" : ["עריכת וידאו"],
      "videoShoot" : ["צילום וידאו, תאורה וסאונד"],
      "whatDoIf" : ["במידה ותחוש שאתה לא ממצה את כישוריך, מה תעשה?"],
      "whatSpecialGive" : ['מה לדעתך השירות כמש"ק דוברות יוכל להקנות לך?'],
      "whatWillGive" : ['מה לדעתך תוכל לתרום במיוחד לחטיבת דובר צה"ל?'],
      ...
      "experienceText": ['פרט על הניסיון בתחום/י התקשורת שבחרת'],
      "worstCharacter" : ["איזו תכונה חלשה או שלילית מאפיינת אותך? איך זה בא לידי ביטוי?"],
      "yourTeacherDesc" : ["איך המחנך שלך היה מתאר אותך?"],
      "motivationRadio" : ['ביחס לתפקידים אחרים/ יחידות אחרות בהן היית רוצה לשרת בצבא, היכן מדורגת חטיבת דובר צה"ל?'],
      ...
      "freeWriteOne": ["אנא כתוב/י בקצרה ובצורה חופשית את עיקרי קורות חייך (ניתן לחזור על דברים שציינתם קודם בשאלון)"],
      "freeWriteTwo": ["אנא כתוב/י בקצרה ובצורה חופשית על אדם/ספר/אירוע שהשפיע עליך"]
    }
  },
  "domain" : "messages"
});
